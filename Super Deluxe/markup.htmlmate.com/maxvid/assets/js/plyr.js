    ...
    function E(v, E) {
        ...
        function q() {
            if (Be.supported.full && ("audio" !== Be.type || E.fullscreen.allowAudio) && E.fullscreen.enabled) {
                ...
                e || E.fullscreen.fallback && !X() ? (Je((e ? "Native" : "Fallback") + " fullscreen enabled"), e || m(Be.container, E.classes.fullscreen.fallback, !0), m(Be.container, E.classes.fullscreen.enabled, !0)) : Je("Fullscreen not supported and fallback disabled"), Be.buttons && Be.buttons.fullscreen && k(Be.buttons.fullscreen, !1), $()
            }
        }
