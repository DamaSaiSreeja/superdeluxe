...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "enable_pacf_through_ywfe_tv": true,
        ...
        "web_all_payloads_via_jspb": true,
        "web_api_url": true,
        ...
        "max_body_size_to_compress": 5000000,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20230804.01.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en",
            "gl": "IN",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20230804.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    const swPolicy = trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(ignored) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/79c80fdc\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(swPolicy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/79c80fdc\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}